...
const POOL: Omit<Pharmacy, "stock" | "distanceKm">[] = [
  {
    ...
    phone: "+234 800 432 1100",
  },
  {
    name: "MedPlus Pharmacy — Lekki",
    address: "Admiralty Way, Lekki Phase 1, Lagos",
    phone: "+234 800 555 2210",
  },
  {
    name: "Alpha Pharmacy — Yaba",
    address: "84 Herbert Macaulay Way, Yaba, Lagos",
    phone: "+234 800 221 9988",
  },
  {
    name: "Emzor Pharmacy — Surulere",
    address: "23 Adeniran Ogunsanya, Surulere, Lagos",
    phone: "+234 800 110 4477",
  },
  {
    name: "Greenlife Pharmacy — Wuse 2",
    address: "Plot 45 Aminu Kano Cres, Wuse 2, Abuja",
    phone: "+234 800 778 6655",
  },
  { name: "Pharmaplus — Garki", address: "Area 11, Garki, Abuja", phone: "+234 800 994 3322" },
  {
    name: "NetPharmacy — Victoria Island",
    address: "Adeola Odeku St, Victoria Island, Lagos",
    phone: "+234 800 612 7788",
  },
  {
    name: "May & Baker Pharmacy — Apapa",
    address: "Wharf Road, Apapa, Lagos",
    phone: "+234 800 553 1109",
  },
];

const STOCK_CYCLE: StockStatus[] = [
  "In Stock",
  "In Stock",
  "Low Stock",
  "In Stock",
